                    ...
                    <div className="mt-20 mb-20">
                        ...
                        <div className="flex xl:flex-row flex-col items-start justify-between">
                            ...
                            <div className="lg:pl-10">
                                ...
                                <div className="">
                                    <div className='w-56 h-54   border-2 border-slate-900 py-3 flex items-center justify-between px-4 rounded-lg mb-6 mt-10 hover:bg-slate-900 hover:text-white' onClick={() => navigate('/restaurants')}>
                                    ...
                                    <div className='w-56 h-54   border-2 border-slate-900 py-3 flex items-center justify-between px-4 rounded-lg mb-6 hover:bg-slate-900 hover:text-white' onClick={() => navigate('/hotels')}>
                                        <div><p className='sm:text-lg text-base font-medium'>Hotels</p></div>
                                        <div className='sm:text-lg text-base'>{Number(hotels.length)}</div>
                                    </div>
                                    <div className='w-56 h-54   border-2 border-slate-900 py-3 flex items-center justify-between px-4 rounded-lg hover:bg-slate-900 hover:text-white' onClick={() => navigate('/attractions')}>
